...
kind: local
# tools omitido de propósito: o agente original no Claude Code também não
# restringe tools ("All tools"). Aqui isso significa herdar tudo da sessão
# Gemini, sem isolamento de fato (ver docs/agentic-sync/schemas/gemini.md).
---
