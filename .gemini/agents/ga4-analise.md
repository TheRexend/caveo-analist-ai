...
> Nota de tradução: o agente original (Claude Code) não restringe `tools`,
> então este espelho também não restringe — herda tudo da sessão principal,
> sem isolamento de fato.
