...
- **OFERTA** — argumento de aquisição/conversão. Responde *"por que a Caveo / por que agora?"* (custo, urgência, posicionamento).
- **FUNCIONALIDADES** — demonstração de uso. Responde *"como isso facilita meu dia?"* (a feature em ação, tangibilizada).

---

## 🟦 Pilar Oferta

| Tema | Ângulo central | Dor / desejo |
|---|---|---|
| CNPJ por R$0 | "R$4.000 no mercado vs R$0 na Caveo" | Custo alto pra abrir empresa |
| Fim da mensalidade do contador | Boleto recorrente que some | Custo fixo mensal que pesa |
| CNPJ = passaporte do plantão | "Sem CNPJ você não faz plantão" (urgência) | Ficar de fora do trabalho |
| Migração de quem já é PJ | "Traga sua empresa pra Caveo" | Inércia / medo de trocar |
...
| Tema | Ângulo central | Dor / desejo |
|---|---|---|
| Emissão de NF em segundos | Velocidade pós-plantão (cronômetro) | Emitir nota na mão rouba tempo |
| Quanto sobra pra você | Faturamento somado + imposto + líquido | Não saber o que de fato sobra |
| Lembrete de pagamentos | Nunca mais multa por esquecimento | Perder prazo entre plantões |
| Recebimento na hora | Saldo caindo na emissão da nota | Esperar o pagamento do plantão |
| Simulador antes de fechar | "Simule quanto vai sobrar antes de aceitar o plantão/contrato" | Decidir no escuro sem saber o imposto |
| Faturamento consolidado | Plantão + clínica + cooperativa num lugar só | Dinheiro espalhado, sem clareza |
| O app faz o que o contador fazia | Substituição visível do contador | Depender de terceiro pra tudo |

---

## Guardrails do spec

- **Recebimento** aparece nos dois pilares de propósito, com tratamento distinto: em Oferta é o *"por quê"* (segurança financeira); em Funcionalidades é o *"como"* (saldo subindo). Ambos os temas de recebimento devem ser **segurados para o 2º lote** — só sobem após validar a tese de CNPJ/oferta (tema financeiro tende a poluir a rede / atrair público de baixa qualidade).
